#=================================================================================================================#
# Exploratory analysis of 10x Genomics scRNA-Seq [EX0023 with VDJ information]
# Date: 01.01.2023
...
# - genotype cells from the skin and merged blood 
#   of the HSCT patient 2 (host/donor) 
#=================================================================================================================#
#=================================================================================================================#
# Prepare R session
#=================================================================================================================#
...
json.sk<-jsonlite::fromJSON("./CZ0128_skin/outs/summary.json")
json.bd<-jsonlite::fromJSON("./CZ0124_blood/outs/summary.json")

# Load barcodes for skin and blood
bc.sk <- readLines("./CZ0128_skin/outs/raw_allele_bc_matrices_mex/ref/barcodes.tsv")
bc.bd <- readLines("./CZ0124_blood/outs/raw_allele_bc_matrices_mex/ref/barcodes.tsv")

# Mix should have all barcodes of skin (19 barcodes overlapped with blood and were removed from blood for snpclust analysis)
...
tb.mp <- data.frame(skin = paste0(round(mp.sk, digits = 3)*100, "%"), 
                    blood = paste0(round(mp.bd, digits = 3)*100, "%"), row.names = "Probability of 2 genotypes")
...
ref.sk<-as.matrix(Matrix::readMM("./CZ0128_skin/outs/raw_allele_bc_matrices_mex/ref/matrix.mtx"))
alt.sk<-as.matrix(Matrix::readMM("./CZ0128_skin/outs/raw_allele_bc_matrices_mex/alt/matrix.mtx"))
...
ref.bd<-as.matrix(Matrix::readMM("./CZ0124_blood/outs/raw_allele_bc_matrices_mex/ref/matrix.mtx"))
alt.bd<-as.matrix(Matrix::readMM("./CZ0124_blood/outs/raw_allele_bc_matrices_mex/alt/matrix.mtx"))
...
rr.sk<-Matrix::readMM("./CZ0128_skin/outs/likelihood_allele_bc_matrices_mex/0_0/matrix.mtx")
ra.sk<-Matrix::readMM("./CZ0128_skin/outs/likelihood_allele_bc_matrices_mex/1_0/matrix.mtx")
aa.sk<-Matrix::readMM("./CZ0128_skin/outs/likelihood_allele_bc_matrices_mex/1_1/matrix.mtx")

rr.bd<-Matrix::readMM("./CZ0124_blood/outs/likelihood_allele_bc_matrices_mex/0_0/matrix.mtx")
ra.bd<-Matrix::readMM("./CZ0124_blood/outs/likelihood_allele_bc_matrices_mex/1_0/matrix.mtx")
aa.bd<-Matrix::readMM("./CZ0124_blood/outs/likelihood_allele_bc_matrices_mex/1_1/matrix.mtx")
...
tb.gs <- data.frame(cbind(skin=table(ga.sk), blood=table(ga.bd)), row.names = c("ref/ref", "ref/alt", "alt/alt"))
...
# Load identified SNV
snp.sk <- read.delim("./CZ0128_skin/outs/raw_allele_bc_matrices_mex/alt/genes.tsv",as.is = T,header = F)[,1]
snp.bd <- read.delim("./CZ0124_blood/outs/raw_allele_bc_matrices_mex/alt/genes.tsv",as.is = T,header = F)[,1]
...
write.csv(bc.gt.sk, file = paste0("./Results/", "barcodes_skin.csv"), quote = F, row.names = T)
write.csv(bc.gt.bd, file = paste0("./Results/", "barcodes_blood.csv"), quote = F, row.names = T)

write.table(bc.gt.sk[bc.gt.sk$genotype == "host", "barcode"], file = paste0("./Results/", "barcodes_skin_host.tsv"), 
            quote = F, row.names = F, col.names = F)
write.table(bc.gt.sk[bc.gt.sk$genotype == "donor", "barcode"], file = paste0("./Results/", "barcodes_skin_donor.tsv"), 
            quote = F, row.names = F, col.names = F)
write.table(bc.gt.bd[bc.gt.bd$genotype == "host", "barcode"], file = paste0("./Results/", "barcodes_blood_host.tsv"), 
            quote = F, row.names = F, col.names = F)
write.table(bc.gt.bd[bc.gt.bd$genotype == "donor", "barcode"], file = paste0("./Results/", "barcodes_blood_donor.tsv"), 
            quote = F, row.names = F, col.names = F)
